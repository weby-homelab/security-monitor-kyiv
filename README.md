...
### 🌟 Що нового:
1.  **PWA Support (Додаток на телефон):**
...
2.  **Розширений моніторинг повітря:**
    ...
    *   **Open-Meteo API:** Отримання актуальної температури, вологості, PM2.5 та PM10.
    *   **Розумний UI:** Віджет динамічно показує доступні параметри. Якщо станція не передає PM1, цей показник автоматично приховується.
